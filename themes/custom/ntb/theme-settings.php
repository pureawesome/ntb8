 ...
 */
function ntb_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['ntb_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('ntb sample setting'),
  '#default_value' => theme_get_setting('ntb_example'),
